...
import com.dap.system.sys.service.ISysPermissionService;
import com.dap.system.sys.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    public void export(HttpServletResponse response, SysUser user) throws IOException
    {
        ...
        util.exportExcel(response, list, "用户数据", null, null,null,null);
    }
    ...
    public AjaxResult getInfo()
    {
        ...
        Long userCustomizeId = SecurityUtils.getUserCustomizeId();
        // 角色集合
